...
export class AppComponent implements OnInit, OnDestroy{
  ...
  getAgentAssistSettings(params){
    ...
    this.serviceInvoker.invoke('get.settings', {instanceBotId : instanceBotId, channel : params.channel}, {},{ apicall : 'settings', botId : params.botId },params.agentassisturl).pipe(finalize(() => {this.widgetLoader = false})).subscribe((res)=> {
