...
export class ChecklistComponent {
  ...
  resumeAndUpdateCheckList(i) {
    ...
    if(this.rootService.widgetMaxButtonClick){
      this.minimizeToggle();
    }
  }
  ...
  getCheckListData() {
    ...
    this.subs.sink = this.serviceInvoker.invoke('get.checklist', { botId: botId }, {}, { excludeAccountId: 'false', botId: botId }, this.connectionDetails.agentassisturl).subscribe((data) => {
  ...
  selectStageAndMinimize(index){
    if(!this.maxButton && this.rootService.widgetMaxButtonClick){
      this.minimizeToggle();
    }
