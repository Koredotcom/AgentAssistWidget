...
export class ChecklistComponent {
  ...
  getCheckListData() {
    ...
    this.subs.sink = this.serviceInvoker.invoke('get.checklist', { botId: botId }, {}, { apicall: 'checklist', botId: botId }, this.connectionDetails.agentassisturl).subscribe((data) => {
