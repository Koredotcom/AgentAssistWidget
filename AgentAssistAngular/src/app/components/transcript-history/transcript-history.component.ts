...
//       "hasMore": true
//    }
    this.serviceInvoker.invoke('get.transcriptHistory', { convId: params.conversationId }, {}, { apicall: 'transcriptHistory', botId : params.botId }, params.agentassisturl).subscribe((data)=> {
