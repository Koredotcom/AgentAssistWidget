...
export class EndPointsService {
  ...
  public init() {
    ...
    this.serviceList['get.transcriptHistory'] = {
      endpoint : '/agentassist/api/v1/agentassistconversations/:convId/conversation?page=0&limit=500&botId=:botId&sessionId=:sessionId&isSummaryRequired=:isSummaryRequired',
      method : 'get',
      defaultEndPoint : false
    }
